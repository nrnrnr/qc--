...
section "text"
{
    ...
    {
        ;
        @i_context = $m(32B)[($r(32)[31]+32::bits32)];
        @i_context = @i_context;
        @i_@1i_2 = 0::bits32;
...
section "text"
{
    ...
    {
        ;
        @i_inputLen = $m(32B)[($r(32)[31]+192::bits32)];
        @i_input = $m(32B)[($r(32)[31]+160::bits32)];
        @i_context = $m(32B)[($r(32)[31]+128::bits32)];
        @i_context = @i_context;
        @i_input = @i_input;
        ...
        $m(32B)[($r(32)[31]+64::bits32)] = @i_@4i_partLen;
        $m(32B)[($r(32)[31]+32::bits32)] = @i_input;
        $m(32B)[$r(32)[31]] = (@i_@3i_index+(@i_context+24::bits32));
        $c(32)[0], $r(32)[30]
            = $m(32B)[sym@@i_MD5_memcpy], ($c(32)[0]+4::bits32);
        ;
        $m(32B)[($r(32)[31]+64::bits32)] = (@i_context+24::bits32);
        $m(32B)[($r(32)[31]+32::bits32)] = @i_context;
        $c(32)[0], $r(32)[30]
        ...
        sym@@i_7:
        $m(32B)[($r(32)[31]+64::bits32)] = (@i_inputLen-@i_@2i_i);
        $m(32B)[($r(32)[31]+32::bits32)] = (@i_@2i_i+@i_input);
        $m(32B)[$r(32)[31]] = (@i_@3i_index+(@i_context+24::bits32));
        $c(32)[0], $r(32)[30]
            = $m(32B)[sym@@i_MD5_memcpy], ($c(32)[0]+4::bits32);
        ;
        ...
        ;
        sym@@i_8:
        $m(32B)[($r(32)[31]+64::bits32)] = (@i_@2i_i+@i_input);
        $m(32B)[($r(32)[31]+32::bits32)] = @i_context;
        $c(32)[0], $r(32)[30]
            = $m(32B)[sym@@i_MD5Transform], ($c(32)[0]+4::bits32);
        ;
...
section "text"
{
    ...
    {
        ;
        @i_context = $m(32B)[($r(32)[31]+192::bits32)];
        @i_digest = $m(32B)[($r(32)[31]+160::bits32)];
        @i_context = @i_context;
        $m(32B)[($r(32)[31]+64::bits32)] = 8::bits32;
        $m(32B)[($r(32)[31]+32::bits32)] = (@i_context+16::bits32);
        $m(32B)[$r(32)[31]]
            = $m(32B)[$m(32B)[($r(32)[31]+128::bits32)]];
        $c(32)[0], $r(32)[30]
        ...
        $m(32B)[($r(32)[31]+64::bits32)] = @i_@14i_padLen;
        $m(32B)[($r(32)[31]+32::bits32)] = $m(32B)[sym@@i_PADDING];
        $m(32B)[$r(32)[31]] = @i_context;
        $c(32)[0], $r(32)[30]
            = $m(32B)[sym@_MD5Update_perl], ($c(32)[0]+4::bits32);
        ;
        $m(32B)[($r(32)[31]+64::bits32)] = 8::bits32;
        $m(32B)[($r(32)[31]+32::bits32)]
            = $m(32B)[$m(32B)[($r(32)[31]+128::bits32)]];
        $m(32B)[$r(32)[31]] = @i_context;
        $c(32)[0], $r(32)[30]
            = $m(32B)[sym@_MD5Update_perl], ($c(32)[0]+4::bits32);
        ;
        $m(32B)[($r(32)[31]+64::bits32)] = 16::bits32;
        $m(32B)[($r(32)[31]+32::bits32)] = @i_context;
        $m(32B)[$r(32)[31]] = @i_digest;
        $c(32)[0], $r(32)[30]
            = $m(32B)[sym@@i_Encode], ($c(32)[0]+4::bits32);
        ;
        $m(32B)[($r(32)[31]+64::bits32)] = 88::bits32;
        $m(32B)[($r(32)[31]+32::bits32)] = 0::bits32;
        $m(32B)[$r(32)[31]] = @i_context;
        $c(32)[0], $r(32)[30]
...
section "text"
{
    ...
    {
        ;
        @i_block = $m(32B)[($r(32)[31]+224::bits32)];
        @i_state = $m(32B)[($r(32)[31]+192::bits32)];
        @i_state = @i_state;
        @i_@16i_a = $m(32B)[@i_state];
        @i_@17i_b = $m(32B)[(@i_state+4::bits32)];
        @i_@18i_c = $m(32B)[(@i_state+8::bits32)];
        @i_@19i_d = $m(32B)[(@i_state+12::bits32)];
        $m(32B)[($r(32)[31]+64::bits32)] = 64::bits32;
        $m(32B)[($r(32)[31]+32::bits32)] = @i_block;
        $m(32B)[$r(32)[31]]
            = $m(32B)[$m(32B)[($r(32)[31]+128::bits32)]];
        $c(32)[0], $r(32)[30]
        ...
        @i_@19i_d
            ...
            (@i_@19i_d+
                ...
                %and[32](%com[32](@i_@16i_a), @i_@18i_c))+
                    $m(32B)[$m(32B)[($m(32B)[($r(32)[31]+128::bits32)]+
                        4::bits32)]])+
                    -389564586::bits32));
        @i_@19i_d
            =
...
section "text"
{
    ...
    {
        ;
        @i_len = $m(32B)[($r(32)[31]+96::bits32)];
        @i_input = $m(32B)[($r(32)[31]+64::bits32)];
        @i_output = $m(32B)[($r(32)[31]+32::bits32)];
        @i_output = @i_output;
        @i_input = @i_input;
        @i_len = @i_len;
        @i_@175i_1 = 0::bits32;
...
section "text"
{
    sym@@i_MD5_memset()
    {
        ;
        @i_len = $m(32B)[($r(32)[31]+96::bits32)];
        @i_value = $m(32B)[($r(32)[31]+64::bits32)];
        @i_output = $m(32B)[($r(32)[31]+32::bits32)];
        @i_output = @i_output;
        @i_value = @i_value;
        @i_len = @i_len;
