...
section "text"
{
    sym@_Perl_hv_store()
    {
        ...
        $r31 = $r31;
        // the preceding node is merely asserted
        $c0 when %eq[32](bits32[bits32[($r31+24)]], 0) = sym@Ljoin@l310;
        Ljoin:l311:
        ...
        Ljoin:l306:
        $c0 when %ne[32](bits32[bits32[($r31+28)]], 0) = sym@Ljoin@l303;
        Ljoin:l304:
        $r0 = 0;
        $r31 = ($r31+24);
        $c0 = $t1;
...
section "text"
{
    sym@_Perl_hv_store_ent()
    {
        ...
        $r31 = $r31;
        // the preceding node is merely asserted
        $c0 when %eq[32](bits32[bits32[($r31+28)]], 0) = sym@Ljoin@l403;
        Ljoin:l404:
        ...
        Ljoin:l382:
        $c0 when %ne[32](bits32[bits32[($r31+32)]], 0) = sym@Ljoin@l379;
        Ljoin:l380:
        $r0 = 0;
        $r31 = ($r31+24);
        $c0 = $t1;
...
section "text"
{
    sym@_Perl_hv_delete()
    {
        ...
        $r31 = $r31;
        // the preceding node is merely asserted
        $c0 when %eq[32](bits32[bits32[($r31+24)]], 0) = sym@Ljoin@l473;
        Ljoin:l474:
        ...
        $r31 = $r31;
        // the preceding node is merely asserted
        $c0 when %ne[32](bits32[bits32[($r31+28)]], 0) = sym@Ljoin@l463;
        Ljoin:l464:
...
section "text"
{
    sym@_Perl_hv_delete_ent()
    {
        ...
        $r31 = $r31;
        // the preceding node is merely asserted
        $c0 when %eq[32](bits32[bits32[($r31+28)]], 0) = sym@Ljoin@l549;
        Ljoin:l550:
        ...
        $r31 = $r31;
        // the preceding node is merely asserted
        $c0 when %ne[32](bits32[bits32[($r31+32)]], 0) = sym@Ljoin@l539;
        Ljoin:l540:
...
section "text"
{
    sym@@i_hsplit()
    {
        ...
        $c0 = sym@@i_381;
        @i_381:
        $c0 when %lt[32](@i_@238i_i, @i_@244i_oldsize) = sym@Ljoin@l727;
        Ljoin:l761:
        $c0 = sym@@i_368;
        @i_368:
        $r31 = ($r31+24);
