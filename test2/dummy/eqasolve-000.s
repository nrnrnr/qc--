...
section "text"
{
    ...
    {
        ;
        @i_argv = $m(32B)[($r(32)[31]+352::bits32)];
        @i_argc = $m(32B)[($r(32)[31]+320::bits32)];
        @i_argc = @i_argc;
        @i_argv = @i_argv;
        $m(32B)[($r(32)[31]+64::bits32)] = $m(32B)[sym@@i_18];
        $c(32)[0], $r(32)[30]
            = $m(32B)[sym@_osinit], ($c(32)[0]+4::bits32);
        ;
        $m(32B)[($r(32)[31]+64::bits32)] = 1::bits32;
        $m(32B)[($r(32)[31]+32::bits32)] = 72::bits32;
        $m(32B)[$r(32)[31]]
            = $m(32B)[$m(32B)[($r(32)[31]+132::bits32)]];
        $c(32)[0], $r(32)[30]
            = $m(32B)[sym@_xlbegin], ($c(32)[0]+4::bits32);
        ;
        $m(32B)[($r(32)[31]+64::bits32)]
            = $m(32B)[($m(32B)[($r(32)[31]+132::bits32)]+8::bits32)];
        $c(32)[0], $r(32)[30]
            = $m(32B)[sym@__setjmp], ($c(32)[0]+4::bits32);
        ;
        @i_1 = $m(32B)[($r(32)[31]+320::bits32)];
        ...
        $c(32)[0] = sym@@i_19;
        sym@@i_main@l101:
        $m(32B)[($r(32)[31]+64::bits32)] = $m(32B)[sym@@i_22];
        $c(32)[0], $r(32)[30]
        ...
        ;
        $m(32B)[($r(32)[31]+64::bits32)] = $m(32B)[$m(32B)[sym@_true]];
        $m(32B)[($r(32)[31]+32::bits32)] = 72::bits32;
        $m(32B)[$r(32)[31]]
            = $m(32B)[$m(32B)[($r(32)[31]+132::bits32)]];
        $c(32)[0], $r(32)[30]
        ...
        sym@@i_main@l76:
        @i_3 = 0::bits32;
        $m(32B)[($r(32)[31]+64::bits32)] = @i_3;
        $m(32B)[($r(32)[31]+32::bits32)] = @i_3;
        $m(32B)[$r(32)[31]] = $m(32B)[sym@@i_26];
        $c(32)[0], $r(32)[30]
        ...
        $c(32)[0] = sym@@i_33;
        sym@@i_27:
        $m(32B)[($r(32)[31]+64::bits32)] = 0::bits32;
        ...
        sym@@i_30:
        $m(32B)[($r(32)[31]+64::bits32)] = 0::bits32;
        $m(32B)[($r(32)[31]+32::bits32)] = 1::bits32;
        $m(32B)[$r(32)[31]]
            = $m(32B)[(%shl[32](@i_i, 2::bits32)+@i_argv)];
        $c(32)[0], $r(32)[30]
            = $m(32B)[sym@_xlload], ($c(32)[0]+4::bits32);
        ;
        @i_5 = $m(32B)[($r(32)[31]+320::bits32)];
        ...
        $c(32)[0] = sym@@i_34;
        sym@@i_main@l55:
        $m(32B)[($r(32)[31]+64::bits32)] = $m(32B)[sym@@i_36];
        $c(32)[0], $r(32)[30]
        ...
        $c(32)[0] = sym@@i_43;
        sym@@i_main@l35:
        $m(32B)[($r(32)[31]+64::bits32)] = $m(32B)[sym@@i_45];
        $c(32)[0], $r(32)[30]
        ...
        ;
        @i_8 = $m(32B)[($r(32)[31]+320::bits32)];
        $m(32B)[$m(32B)[($r(32)[31]+128::bits32)]] = @i_8;
        $m(32B)[($r(32)[31]+64::bits32)]
            = $m(32B)[$m(32B)[$m(32B)[($r(32)[31]+128::bits32)]]];
        $c(32)[0], $r(32)[30]
        ...
        $c(32)[0], $r(32)[30]
            = $m(32B)[sym@_exit], ($c(32)[0]+4::bits32);
        ;
        $m(32B)[($r(32)[31]+320::bits32)] = 0::bits32;
        $c(32)[0] = $r(32)[30];
        ;
        ;
    }
...
section "text"
{
    ...
    {
        ;
        @i_expr = $m(32B)[($r(32)[31]+128::bits32)];
        $m(32B)[($r(32)[31]+64::bits32)] = 1::bits32;
        $m(32B)[($r(32)[31]+32::bits32)] = @i_expr;
        $m(32B)[$r(32)[31]]
...
section "text"
{
    ...
    {
        ;
        @i_str = $m(32B)[($r(32)[31]+96::bits32)];
        $m(32B)[($r(32)[31]+32::bits32)] = @i_str;
        $m(32B)[$r(32)[31]]
            = $m(32B)[($m(32B)[$m(32B)[sym@_s_stdout]]+8::bits32)];
        $c(32)[0], $r(32)[30]
