...
_Perl_hv_store:
	...
	leal 68(%esp), %edx
	movl (%edx),%edx
initialize_continuations_l293:
proc_body_start_l292:
	movl %eax,12(%esp)
	movl $0,%eax
	movl %ecx,16(%esp)
	movl (%esp),%ecx
...
_Perl_hv_store_ent:
	...
	leal 72(%esp), %ecx
	movl (%ecx),%ecx
initialize_continuations_l377:
proc_body_start_l376:
	movl %edx,8(%esp)
	movl $0,%edx
	movl %eax,12(%esp)
	movl (%esp),%eax
...
_Perl_hv_delete:
	...
	leal 68(%esp), %ecx
	movl (%ecx),%ecx
initialize_continuations_l488:
proc_body_start_l487:
	movl %edx,8(%esp)
	movl $0,%edx
	movl %eax,12(%esp)
	movl (%esp),%eax
...
_Perl_hv_delete_ent:
	...
	leal 76(%esp), %ecx
	movl (%ecx),%ecx
initialize_continuations_l569:
proc_body_start_l568:
	movl %edx,8(%esp)
	movl $0,%edx
	movl %eax,12(%esp)
	movl (%esp),%eax
