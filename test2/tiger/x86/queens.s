...
.Lbranch_target_l87:
	...
	movl $0,%ecx
	cmpl %ecx,%eax
	je .Lbranch_target_l86
.Lbranch_target_l85:
	movl $0,%eax
	jmp .Lbranch_target_l84
.Lbranch_target_l86:
	movl $-1,%eax
.Lbranch_target_l84:
LifEnd_94:
...
.Lbranch_target_l83:
	...
	movl $0,%ecx
	cmpl %ecx,%eax
	je .Lbranch_target_l82
.Lbranch_target_l81:
	movl $0,%eax
	jmp .Lbranch_target_l80
.Lbranch_target_l82:
	movl $-1,%eax
.Lbranch_target_l80:
LifEnd_100:
...
.Lcall_successor_l110:
	...
	leal 148(%esp), %esp
	ret
.LLinit_start_56_l137:
	movl 100(%esp),%eax
	jmp Linit_start_56
.LLinit_start_49_l136:
	movl 68(%esp),%eax
	jmp Linit_start_49
.LLinit_start_42_l135:
	movl 40(%esp),%eax
	jmp Linit_start_42
.LLinit_start_34_l134:
	movl 20(%esp),%eax
	jmp Linit_start_34
.section .pcmap_data
.Lstackdata_l139:
