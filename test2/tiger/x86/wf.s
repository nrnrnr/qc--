...
add_word_36:
	...
	leal 40(%esp), %edx
	movl (%edx),%edx
initialize_continuations_l106:
proc_body_start_l105:
	movl %eax,(%esp)
	movl $-8,%eax
	movl %ecx,4(%esp)
	leal 40(%esp), %ecx
...
getword_39:
	...
	leal 76(%esp), %ecx
	movl (%ecx),%edx
initialize_continuations_l237:
proc_body_start_l236:
	movl $-12,%ecx
	movl %eax,32(%esp)
	leal 76(%esp), %eax
	addl %ecx,%eax
