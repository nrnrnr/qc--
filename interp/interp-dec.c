              ...
              #line 486 "interp.m"
               {
                                                 ...
                                                 if (sz <= 0 || sz > sizeof(value)*8)
                                                   cmm_err("cannot fetch %d bits", sz);
                                                 ...
                                                 } else {
                                                                              {
                                                                                ...
                                                                                assert(proc != NULL);
                                                                                                          ...
                                                                                                          /* allocate memory, update state of the machine */
                                                                                                           ...
                                                                                                           locals        = t->stack_free;
                                                                                                           t->stack_free = (void *) (((vptr) t->stack_free) +
                                                                                                                                     proc->num_locals);
              ...
              #line 752 "interp.m"
               {
                                                 ...
                                                 pc   = (bytecodeptr) location(proc->raddr);
                                                                            ...
                                                                            caller        = caller;
                                                                            stackdata     = (dataptr) (locals_end = locals + 
                                                                                                       proc->num_locals);
                                                                            stackdata_end = round_up(stackdata + 
                                                                                                     proc->stackdata_size);
              ...
              #line 857 "interp.m"
               {
                                                 ...
                                                 if (cont->dest_act->u.thread != u.thread) {
                                                     ...
                                                     continue;
                                                                            ...
                                                                            u             = cont->dest_act->u;
                                                                            caller        = cont->dest_act->caller;
                                                                            name          = cont->dest_act->name;
        ...
        case 31: 
          { 
            { 
              ...
              #line 508 "interp.m"
               switch (fegetround()) {
                                                 case FE_TOWARDZERO: PUSH(to_CMM_value(0,2), values);
                                                                     break;
                                                 case FE_TONEAREST : PUSH(to_CMM_value(1,2), values);
                                                                     break;
                                                 case FE_UPWARD    : PUSH(to_CMM_value(2,2), values);
                                                                     break;
                                                 case FE_DOWNWARD  : PUSH(to_CMM_value(3,2), values);
                                                                     break;
                                                 default           : cmm_err("invalid rounding "
                                                                             "mode");
                                                 }
                                                 pc = next;
              ...
              #line 521 "interp.m"
               {
                                                 ...
                                                 switch (v.bits2) {
                                                 case 0 : rm = FE_TOWARDZERO; break;
                                                 case 1 : rm = FE_TONEAREST ; break;
                                                 case 2 : rm = FE_UPWARD    ; break;
                                                 case 3 : rm = FE_DOWNWARD  ; break;
                                                 default: cmm_err("invalid rounding mode (%d)", 
                                                                  v.bits2);
                                                 }
