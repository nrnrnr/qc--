...
void O1_0_emitclosure(RClosure c, RelocCallback emit_addr,
    void (*emit_int)(void *closure, unsigned u), void *closure) 
{ 
  O1_0_Closure _c = (O1_0_Closure) c;
  (*emit_addr)(closure, _c->v.a1);
  }
...
void O2_0_emitclosure(RClosure c, RelocCallback emit_addr,
    void (*emit_int)(void *closure, unsigned u), void *closure) 
{ 
  O2_0_Closure _c = (O2_0_Closure) c;
  (*emit_addr)(closure, _c->v.a1);
  (*emit_addr)(closure, _c->v.a2);
  }
...
save_round  is (SAVE_ROUND) op == 31
...
restore_round  is (RESTORE_ROUND) op == 32

***********/
void restore_round(void) {
  emitm(32, 1);
}
/**************
