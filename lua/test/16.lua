...
function image(cs) 
  ...
  if cs then cs = '"' .. cs .. '"' else cs = 'nil' end    
  return cs
end
...
function f(s, p)
  ...
  local cs = c 
--- write('strfind("', s, '", "', p, '") captures ', image(cs), ' at ', image(_), ', ', image(__), '\n')
  return c
end
...
_, __, a, b, c, d, e = strfind("âlo alo", "^(((.).).* (%w*))$")
assert(a == 'âlo alo' and b == 'âl' and c == 'â' and d == 'alo' and e == nil)
assert(f('0123456789', '(.*.?)') == '0123456789')
_, __, a, b, c, d  = strfind('0123456789', '(.*(.?)())')
