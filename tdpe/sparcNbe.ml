...
fun x1 ->
  ...
  Ctrl.shift
    (fun x5 ->
       ...
       Sy.CASE (x1, [("Imode", [r2], r6);("Rmode", [r3], r9)])) in vv4
let reify_address =
fun x1 ->
  (match x1 with 
     | Generala (x2,x3) ->
...
fun x1 ->
  ...
  Ctrl.shift
    (fun x11 ->
       ...
       Sy.CASE
       (x1,
        [("Generala", [r2;r3], r12);("Dispa", [r4;r5], r15);
         ("Absolutea", [r6], r18);("Indexa", [r7;r8], r21);
         ("Indirecta", [r9], r24)])) in vv10
let reify_regaddr =
fun x1 ->
  (match x1 with 
...
fun x1 ->
  ...
  Ctrl.shift
    (fun x6 ->
       ...
       Sy.CASE (x1, [("Indexr", [r2;r3], r7);("Indirectr", [r4], r10)]))
  in vv5
let reify_t =
fun x1 ->
  (match x1 with 
...
fun x1 ->
  ...
  Ctrl.shift
    (fun x430 ->
       ...
       Sy.CASE
       (x1,
        [("Ldsb", [r2;r3], r431);("Ldsh", [r4;r5], r434);
         ("Ldub", [r6;r7], r437);("Lduh", [r8;r9], r440);
         ("Ld", [r10;r11], r443);("Ldstub", [r12;r13], r446);
         ("Swap_", [r14;r15], r449);("Ldd", [r16;r17], r452);
         ("Ldf", [r18;r19], r455);("Lddf", [r20;r21], r458);
         ("Ldc", [r22;r23], r461);("Lddc", [r24;r25], r464);
         ("Stb", [r26;r27], r467);("Sth", [r28;r29], r470);
         ("St", [r30;r31], r473);("Std", [r32;r33], r476);
         ("Stf", [r34;r35], r479);("Stdf", [r36;r37], r482);
         ("Stc", [r38;r39], r485);("Stdc", [r40;r41], r488);
         ("Ldsba", [r42;r43;r44], r491);("Ldsha", [r45;r46;r47], r494);
         ("Lduba", [r48;r49;r50], r497);("Lduha", [r51;r52;r53], r500);
         ("Lda", [r54;r55;r56], r503);("Ldstuba", [r57;r58;r59], r506);
         ("Swapa", [r60;r61;r62], r509);("Ldda", [r63;r64;r65], r512);
         ("Stba", [r66;r67;r68], r515);("Stha", [r69;r70;r71], r518);
         ("Sta", [r72;r73;r74], r521);("Stda", [r75;r76;r77], r524);
         ("Ldfsr", [r78], r527);("Ldcsr", [r79], r530);
         ("Stfsr", [r80], r533);("Stcsr", [r81], r536);
         ("Stdfq", [r82], r539);("Stdcq", [r83], r542);
         ("Rdy", [r84], r545);("Rdpsr", [r85], r548);
         ("Rdwim", [r86], r551);("Rdtbr", [r87], r554);
         ("Wry", [r88;r89], r557);("Wrpsr", [r90;r91], r560);
         ("Wrwim", [r92;r93], r563);("Wrtbr", [r94;r95], r566);
         ("Rdasr", [r96;r97], r569);("Wrasr", [r98;r99;r100], r572);
         ("Stbar", [], r575);("And", [r101;r102;r103], r578);
         ("Andcc", [r104;r105;r106], r581);
         ("Andn", [r107;r108;r109], r584);
         ("Andncc", [r110;r111;r112], r587);
         ("Or", [r113;r114;r115], r590);
         ("Orcc", [r116;r117;r118], r593);
         ("Orn", [r119;r120;r121], r596);
         ("Orncc", [r122;r123;r124], r599);
         ("Xor", [r125;r126;r127], r602);
         ("Xorcc", [r128;r129;r130], r605);
         ("Xnor", [r131;r132;r133], r608);
         ("Xnorcc", [r134;r135;r136], r611);
         ("Sll", [r137;r138;r139], r614);
         ("Srl", [r140;r141;r142], r617);
         ("Sra", [r143;r144;r145], r620);
         ("Add", [r146;r147;r148], r623);
         ("Addcc", [r149;r150;r151], r626);
         ("Addx", [r152;r153;r154], r629);
         ("Addxcc", [r155;r156;r157], r632);
         ("Taddcc", [r158;r159;r160], r635);
         ("Taddcctv", [r161;r162;r163], r638);
         ("Sub", [r164;r165;r166], r641);
         ("Subcc", [r167;r168;r169], r644);
         ("Subx", [r170;r171;r172], r647);
         ("Subxcc", [r173;r174;r175], r650);
         ("Tsubcc", [r176;r177;r178], r653);
         ("Tsubcctv", [r179;r180;r181], r656);
         ("Mulscc", [r182;r183;r184], r659);
         ("Umul", [r185;r186;r187], r662);
         ("Smul", [r188;r189;r190], r665);
         ("Umulcc", [r191;r192;r193], r668);
         ("Smulcc", [r194;r195;r196], r671);
         ("Udiv", [r197;r198;r199], r674);
         ("Sdiv", [r200;r201;r202], r677);
         ("Udivcc", [r203;r204;r205], r680);
         ("Sdivcc", [r206;r207;r208], r683);
         ("Save", [r209;r210;r211], r686);
         ("Restore", [r212;r213;r214], r689);("Bn", [r215], r692);
         ("Bn_a", [r216], r695);("Be", [r217], r698);
         ("Be_a", [r218], r701);("Ble", [r219], r704);
         ("Ble_a", [r220], r707);("Bl", [r221], r710);
         ("Bl_a", [r222], r713);("Bleu", [r223], r716);
         ("Bleu_a", [r224], r719);("Bcs", [r225], r722);
         ("Bcs_a", [r226], r725);("Bneg", [r227], r728);
         ("Bneg_a", [r228], r731);("Bvs", [r229], r734);
         ("Bvs_a", [r230], r737);("Ba", [r231], r740);
         ("Ba_a", [r232], r743);("Bne", [r233], r746);
         ("Bne_a", [r234], r749);("Bg", [r235], r752);
         ("Bg_a", [r236], r755);("Bge", [r237], r758);
         ("Bge_a", [r238], r761);("Bgu", [r239], r764);
         ("Bgu_a", [r240], r767);("Bcc", [r241], r770);
         ("Bcc_a", [r242], r773);("Bpos", [r243], r776);
         ("Bpos_a", [r244], r779);("Bvc", [r245], r782);
         ("Bvc_a", [r246], r785);("Fbn", [r247], r788);
         ("Fbn_a", [r248], r791);("Fbne", [r249], r794);
         ("Fbne_a", [r250], r797);("Fblg", [r251], r800);
         ("Fblg_a", [r252], r803);("Fbul", [r253], r806);
         ("Fbul_a", [r254], r809);("Fbl", [r255], r812);
         ("Fbl_a", [r256], r815);("Fbug", [r257], r818);
         ("Fbug_a", [r258], r821);("Fbg", [r259], r824);
         ("Fbg_a", [r260], r827);("Fbu", [r261], r830);
         ("Fbu_a", [r262], r833);("Fba", [r263], r836);
         ("Fba_a", [r264], r839);("Fbe", [r265], r842);
         ("Fbe_a", [r266], r845);("Fbue", [r267], r848);
         ("Fbue_a", [r268], r851);("Fbge", [r269], r854);
         ("Fbge_a", [r270], r857);("Fbuge", [r271], r860);
         ("Fbuge_a", [r272], r863);("Fble", [r273], r866);
         ("Fble_a", [r274], r869);("Fbule", [r275], r872);
         ("Fbule_a", [r276], r875);("Fbo", [r277], r878);
         ("Fbo_a", [r278], r881);("Cbn", [r279], r884);
         ("Cbn_a", [r280], r887);("Cb123", [r281], r890);
         ("Cb123_a", [r282], r893);("Cb12", [r283], r896);
         ("Cb12_a", [r284], r899);("Cb13", [r285], r902);
         ("Cb13_a", [r286], r905);("Cb1", [r287], r908);
         ("Cb1_a", [r288], r911);("Cb23", [r289], r914);
         ("Cb23_a", [r290], r917);("Cb2", [r291], r920);
         ("Cb2_a", [r292], r923);("Cb3", [r293], r926);
         ("Cb3_a", [r294], r929);("Cba", [r295], r932);
         ("Cba_a", [r296], r935);("Cb0", [r297], r938);
         ("Cb0_a", [r298], r941);("Cb03", [r299], r944);
         ("Cb03_a", [r300], r947);("Cb02", [r301], r950);
         ("Cb02_a", [r302], r953);("Cb023", [r303], r956);
         ("Cb023_a", [r304], r959);("Cb01", [r305], r962);
         ("Cb01_a", [r306], r965);("Cb013", [r307], r968);
         ("Cb013_a", [r308], r971);("Cb012", [r309], r974);
         ("Cb012_a", [r310], r977);("Call", [r311], r980);
         ("Fmovs", [r312;r313], r983);("Fnegs", [r314;r315], r986);
         ("Fabss", [r316;r317], r989);("Fsqrts", [r318;r319], r992);
         ("Fsqrtd", [r320;r321], r995);("Fsqrtq", [r322;r323], r998);
         ("Fitos", [r324;r325], r1001);("Fstoi", [r326;r327], r1004);
         ("Fitod", [r328;r329], r1007);("Fstod", [r330;r331], r1010);
         ("Fitoq", [r332;r333], r1013);("Fstoq", [r334;r335], r1016);
         ("Fdtoi", [r336;r337], r1019);("Fdtos", [r338;r339], r1022);
         ("Fqtos", [r340;r341], r1025);("Fqtoi", [r342;r343], r1028);
         ("Fqtod", [r344;r345], r1031);("Fdtoq", [r346;r347], r1034);
         ("Fadds", [r348;r349;r350], r1037);
         ("Fsubs", [r351;r352;r353], r1040);
         ("Fmuls", [r354;r355;r356], r1043);
         ("Fdivs", [r357;r358;r359], r1046);
         ("Faddd", [r360;r361;r362], r1049);
         ("Fsubd", [r363;r364;r365], r1052);
         ("Fmuld", [r366;r367;r368], r1055);
         ("Fdivd", [r369;r370;r371], r1058);
         ("Faddq", [r372;r373;r374], r1061);
         ("Fsubq", [r375;r376;r377], r1064);
         ("Fmulq", [r378;r379;r380], r1067);
         ("Fdivq", [r381;r382;r383], r1070);
         ("Fsmuld", [r384;r385;r386], r1073);
         ("Fdmulq", [r387;r388;r389], r1076);
         ("Fcmps", [r390;r391], r1079);("Fcmpes", [r392;r393], r1082);
         ("Fcmpd", [r394;r395], r1085);("Fcmped", [r396;r397], r1088);
         ("Fcmpq", [r398;r399], r1091);("Fcmpeq", [r400;r401], r1094);
         ("Nop", [], r1097);("Flush", [r402], r1100);
         ("Jmpl", [r403;r404], r1103);("Rett", [r405], r1106);
         ("Tn", [r406], r1109);("Te", [r407], r1112);
         ("Tle", [r408], r1115);("Tl", [r409], r1118);
         ("Tleu", [r410], r1121);("Tcs", [r411], r1124);
         ("Tneg", [r412], r1127);("Tvs", [r413], r1130);
         ("Ta", [r414], r1133);("Tne", [r415], r1136);
         ("Tg", [r416], r1139);("Tge", [r417], r1142);
         ("Tgu", [r418], r1145);("Tcc", [r419], r1148);
         ("Tpos", [r420], r1151);("Tvc", [r421], r1154);
         ("Unimp", [r422], r1157);("Sethi", [r423;r424], r1160);
         ("Decode_sethi", [r425;r426], r1163);
         ("Set", [r427;r428], r1166)])) in vv429
