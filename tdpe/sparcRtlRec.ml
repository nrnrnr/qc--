module M(Instruction : SparcConstructors.S) = struct 
  ...
  module RP = Rtl.Private
    ...
    let defaultOfInstruction rtl = 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1' && (Bitops.fits_signed arg18 
            13 && Bitops.eq arg17 (Bits.of_int 255 8))) -> 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1' && Bitops.eq rs2 rs2' && 
          Bitops.eq arg19 (Bits.of_int 255 8)) -> 
           Instruction.ldstub (Instruction.generala (Bits.to_nativeint rs1) 
                 (Instruction.rmode (Bits.to_nativeint rs2))) 
             (Bits.to_nativeint rd) 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1' && (Bitops.fits_signed arg22 
            13 && Bitops.eq arg21 (Bits.of_int 255 8))) -> 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1' && Bitops.eq rs2 rs2' && 
          Bitops.eq arg26 (Bits.of_int 255 8)) -> 
      ...
      when Base.to_bool 
          (Bitops.eq rs1 rs1' && Bitops.eq arg27 (Bits.of_int 255 8)) -> 
      ...
      when Base.to_bool (Bitops.eq rd rd' && Bitops.eq rs1 rs1' && 
          Bitops.fits_signed arg29 13) -> 
      ...
      | RP.Rtl [(RP.Const (RP.Bool true), RP.Store (RP.Cell ('r', Rtl.Identity, 
          ...
          (RP.Const (RP.Bool true), RP.Store (RP.Cell ('m', Rtl.Identity, 32, 
              ...
              RP.Fetch (RP.Cell ('r', Rtl.Identity, 32, RP.Const (RP.Bits rd), 
                _), 32), 32))] 
      when Base.to_bool 
          (Bitops.eq rd rd' && Bitops.eq rs1 rs1' && Bitops.eq rs2 rs2') -> 
           Instruction.swap_ (Instruction.generala (Bits.to_nativeint rs1) 
                 (Instruction.rmode (Bits.to_nativeint rs2))) 
             (Bits.to_nativeint rd) 
      ...
      | RP.Rtl [(RP.Const (RP.Bool true), RP.Store (RP.Cell ('r', Rtl.Identity, 
          ...
          (RP.Const (RP.Bool true), RP.Store (RP.Cell ('m', Rtl.Identity, 32, 
              RP.Const (RP.Bits arg32), _), RP.Fetch (RP.Cell ('r', 
                Rtl.Identity, 32, RP.Const (RP.Bits rd), _), 32), 32))] 
      when Base.to_bool 
          (Bitops.eq rd rd' && Bitops.fits_signed arg33 13) -> 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1'''' && Bitops.eq rs1 rs1''' && 
          Bitops.eq rs1 rs1'' && Bitops.eq rs1 rs1' && (Bitops.fits_signed 
            arg82 13 && Bitops.eq arg79 (Bits.of_int 0 32) && Bitops.eq arg80 
            (Bits.of_int 0 3) && Bitops.eq arg81 (Bits.of_int 1 1) && Bitops.eq 
            arg75 (Bits.of_int 0 32) && Bitops.eq arg76 (Bits.of_int 0 3) && 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1'''' && Bitops.eq rs2 rs2'''' && 
          Bitops.eq rs1 rs1''' && Bitops.eq rs2 rs2''' && Bitops.eq rs1 
            rs1'' && Bitops.eq rs2 rs2'' && Bitops.eq rs1 rs1' && Bitops.eq rs2 
            rs2' && (Bitops.eq arg96 (Bits.of_int 0 32) && Bitops.eq arg97 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1'''' && Bitops.eq rs1 rs1''' && Bitops.eq rs1 
          rs1'' && Bitops.eq rs1 rs1' && Base.qbool false) -> 
           Sledlib.fail 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1'''' && Bitops.eq rs2 rs2'''' && 
          Bitops.eq rs1 rs1''' && Bitops.eq rs2 rs2''' && Bitops.eq rs1 
            rs1'' && Bitops.eq rs2 rs2'' && Bitops.eq rs1 rs1' && Bitops.eq rs2 
            rs2' && (Bitops.eq arg134 (Bits.of_int 0 32) && Bitops.eq arg135 
            (Bits.of_int 0 3) && Bitops.eq arg136 (Bits.of_int 1 1) && 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1'''' && Bitops.eq rs1 rs1''' && 
          Bitops.eq rs1 rs1'' && Bitops.eq rs1 rs1' && (Bitops.fits_signed 
            arg158 13 && Bitops.eq arg155 (Bits.of_int 0 32) && Bitops.eq 
            arg156 (Bits.of_int 0 3) && Bitops.eq arg157 (Bits.of_int 1 1) && 
          Bitops.eq arg151 (Bits.of_int 0 32) && Bitops.eq arg152 (Bits.of_int 
              0 3) && Bitops.eq arg153 (Bits.of_int 0 1) && Bitops.eq arg147 
            (Bits.of_int 0 32) && Bitops.eq arg148 (Bits.of_int 0 3) && 
          Bitops.eq arg149 (Bits.of_int 1 1) && Bitops.eq arg143 (Bits.of_int 0 
              32) && Bitops.eq arg144 (Bits.of_int 0 3) && Bitops.eq arg145 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1'''' && Bitops.eq rs2 rs2'''' && 
          Bitops.eq rs1 rs1''' && Bitops.eq rs2 rs2''' && Bitops.eq rs1 
            rs1'' && Bitops.eq rs2 rs2'' && Bitops.eq rs1 rs1' && Bitops.eq rs2 
            rs2' && (Bitops.eq arg172 (Bits.of_int 0 32) && Bitops.eq arg173 
            (Bits.of_int 0 3) && Bitops.eq arg174 (Bits.of_int 1 1) && 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1'''' && Bitops.eq rs2 rs2'''' && 
          Bitops.eq rs1 rs1''' && Bitops.eq rs2 rs2''' && Bitops.eq rs1 
            rs1'' && Bitops.eq rs2 rs2'' && Bitops.eq rs1 rs1' && Bitops.eq rs2 
            rs2' && (Bitops.eq arg210 (Bits.of_int 0 32) && Bitops.eq arg211 
            (Bits.of_int 0 3) && Bitops.eq arg212 (Bits.of_int 1 1) && 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1'''' && Bitops.eq rs1 rs1''' && 
          Bitops.eq rs1 rs1'' && Bitops.eq rs1 rs1' && (Bitops.fits_signed 
            arg234 13 && Bitops.eq arg231 (Bits.of_int 0 32) && Bitops.eq 
            arg232 (Bits.of_int 0 3) && Bitops.eq arg233 (Bits.of_int 1 1) && 
          Bitops.eq arg227 (Bits.of_int 0 32) && Bitops.eq arg228 (Bits.of_int 
              0 3) && Bitops.eq arg229 (Bits.of_int 0 1) && Bitops.eq arg223 
            (Bits.of_int 0 32) && Bitops.eq arg224 (Bits.of_int 0 3) && 
          Bitops.eq arg225 (Bits.of_int 1 1) && Bitops.eq arg219 (Bits.of_int 0 
              32) && Bitops.eq arg220 (Bits.of_int 0 3) && Bitops.eq arg221 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1'''' && Bitops.eq rs2 rs2'''' && 
          Bitops.eq rs1 rs1''' && Bitops.eq rs2 rs2''' && Bitops.eq rs1 
            rs1'' && Bitops.eq rs2 rs2'' && Bitops.eq rs1 rs1' && Bitops.eq rs2 
            rs2' && (Bitops.eq arg248 (Bits.of_int 0 32) && Bitops.eq arg249 
            (Bits.of_int 0 3) && Bitops.eq arg250 (Bits.of_int 1 1) && 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1'''' && Bitops.eq rs2 rs2'''' && 
          Bitops.eq rs1 rs1''' && Bitops.eq rs2 rs2''' && Bitops.eq rs1 
            rs1'' && Bitops.eq rs2 rs2'' && Bitops.eq rs1 rs1' && Bitops.eq rs2 
            rs2' && (Bitops.eq arg286 (Bits.of_int 0 32) && Bitops.eq arg287 
            (Bits.of_int 0 3) && Bitops.eq arg288 (Bits.of_int 1 1) && 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1'''''''''''' && Bitops.eq rs1 
            rs1''''''''''' && Bitops.eq rs1 rs1'''''''''' && Bitops.eq rs1 
            rs1''''''''' && Bitops.eq rs1 rs1'''''''' && Bitops.eq rs1 
            rs1''''''' && Bitops.eq rs1 rs1'''''' && Bitops.eq rs1 rs1''''' && 
          Bitops.eq rs1 rs1'''' && Bitops.eq rs1 rs1''' && Bitops.eq rs1 
            rs1'' && Bitops.eq rs1 rs1' && (Bitops.fits_signed arg327 13 && 
          Bitops.eq arg324 (Bits.of_int 0 32) && Bitops.eq arg325 (Bits.of_int 
              0 3) && Bitops.eq arg326 (Bits.of_int 1 1) && Bitops.eq arg320 
            (Bits.of_int 0 32) && Bitops.eq arg321 (Bits.of_int 0 3) && 
          Bitops.eq arg322 (Bits.of_int 0 1) && Bitops.eq arg316 (Bits.of_int 0 
              32) && Bitops.eq arg317 (Bits.of_int 0 3) && Bitops.eq arg318 
            (Bits.of_int 1 1) && Bitops.eq arg312 (Bits.of_int 0 32) && 
          Bitops.eq arg313 (Bits.of_int 0 3) && Bitops.eq arg314 (Bits.of_int 0 
              1) && Bitops.eq arg307 (Bits.of_int 31 32) && Bitops.eq arg306 
            (Bits.of_int 31 32) && Bitops.eq arg305 (Bits.of_int 31 32) && 
          Bitops.eq arg309 (Bits.of_int 0 3) && Bitops.eq arg310 
            (Bits.of_int 1 1) && Bitops.eq arg300 (Bits.of_int 31 32) && 
          Bitops.eq arg299 (Bits.of_int 31 32) && Bitops.eq arg298 
            (Bits.of_int 31 32) && Bitops.eq arg302 (Bits.of_int 0 3) && 
          Bitops.eq arg303 (Bits.of_int 0 1) && Bitops.eq arg293 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1'''''''''''' && Bitops.eq rs2 
            rs2'''''''''' && Bitops.eq rs1 rs1''''''''''' && Bitops.eq rs2 
            rs2''''''''' && Bitops.eq rs1 rs1'''''''''' && Bitops.eq rs2 
            rs2'''''''' && Bitops.eq rs1 rs1''''''''' && Bitops.eq rs2 
            rs2''''''' && Bitops.eq rs1 rs1'''''''' && Bitops.eq rs2 
            rs2'''''' && Bitops.eq rs1 rs1''''''' && Bitops.eq rs2 rs2''''' && 
          Bitops.eq rs1 rs1'''''' && Bitops.eq rs1 rs1''''' && Bitops.eq rs2 
            rs2'''' && Bitops.eq rs1 rs1'''' && Bitops.eq rs2 rs2''' && 
          Bitops.eq rs1 rs1''' && Bitops.eq rs1 rs1'' && Bitops.eq rs2 rs2'' && 
          Bitops.eq rs1 rs1' && Bitops.eq rs2 rs2' && (Bitops.eq arg355 
            (Bits.of_int 0 32) && Bitops.eq arg356 (Bits.of_int 0 3) && 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1'''''''''''' && Bitops.eq rs1 
            ...
            rs1''''''' && Bitops.eq rs1 rs1'''''' && Bitops.eq rs1 rs1''''' && 
          Bitops.eq rs1 rs1'''' && Bitops.eq rs1 rs1''' && Bitops.eq rs1 
            rs1'' && Bitops.eq rs1 rs1' && (Bitops.fits_signed arg405 13 && 
          Bitops.eq arg404 (Bits.of_int 0 3) && Bitops.eq arg399 (Bits.of_int 0 
              3) && Bitops.eq arg401 (Bits.of_int 0 32) && Bitops.eq arg402 
            (Bits.of_int 0 3) && Bitops.eq arg403 (Bits.of_int 1 1) && 
          Bitops.eq arg394 (Bits.of_int 0 3) && Bitops.eq arg396 (Bits.of_int 0 
              32) && Bitops.eq arg397 (Bits.of_int 0 3) && Bitops.eq arg398 
            (Bits.of_int 0 1) && Bitops.eq arg389 (Bits.of_int 0 3) && 
          Bitops.eq arg391 (Bits.of_int 0 32) && Bitops.eq arg392 (Bits.of_int 
              0 3) && Bitops.eq arg393 (Bits.of_int 1 1) && Bitops.eq arg384 
            (Bits.of_int 0 3) && Bitops.eq arg386 (Bits.of_int 0 32) && 
          Bitops.eq arg387 (Bits.of_int 0 3) && Bitops.eq arg388 (Bits.of_int 0 
              1) && Bitops.eq arg380 (Bits.of_int 31 32) && Bitops.eq arg379 
            (Bits.of_int 31 32) && Bitops.eq arg378 (Bits.of_int 31 32) && 
          Bitops.eq arg376 (Bits.of_int 0 3) && Bitops.eq arg382 (Bits.of_int 0 
              3) && Bitops.eq arg383 (Bits.of_int 1 1) && Bitops.eq arg372 
            (Bits.of_int 31 32) && Bitops.eq arg371 (Bits.of_int 31 32) && 
          Bitops.eq arg370 (Bits.of_int 31 32) && Bitops.eq arg368 
            (Bits.of_int 0 3) && Bitops.eq arg374 (Bits.of_int 0 3) && 
          Bitops.eq arg375 (Bits.of_int 0 1) && Bitops.eq arg364 
            (Bits.of_int 31 32) && Bitops.eq arg366 (Bits.of_int 0 3) && 
          Bitops.eq arg367 (Bits.of_int 0 1) && Bitops.eq arg361 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1'''''''''''' && Bitops.eq rs2 
          ...
          Bitops.eq rs1 rs1'''''' && Bitops.eq rs1 rs1''''' && Bitops.eq rs2 
            rs2'''' && Bitops.eq rs1 rs1'''' && Bitops.eq rs2 rs2''' && 
          Bitops.eq rs1 rs1''' && Bitops.eq rs1 rs1'' && Bitops.eq rs2 rs2'' && 
          Bitops.eq rs1 rs1' && Bitops.eq rs2 rs2' && (Bitops.eq arg442 
            (Bits.of_int 0 3) && Bitops.eq arg438 (Bits.of_int 0 3) && 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1' && (Bitops.fits_signed arg446 
            13 && Bitops.eq arg445 (Bits.of_int 3 3) && Bitops.eq arg447 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1' && (Bitops.fits_signed arg454 
            13 && Bitops.eq arg453 (Bits.of_int 3 3) && Bitops.eq arg455 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1''''' && Bitops.eq rs1 rs1'''' && 
          Bitops.eq rs1 rs1''' && Bitops.eq rs1 rs1'' && Bitops.eq rs1 rs1' && 
          (Bitops.fits_signed arg482 13 && Bitops.eq arg481 (Bits.of_int 3 
              3) && Bitops.eq arg483 (Bits.of_int 32 32) && Bitops.eq arg480 
            (Bits.of_int 0 32) && Bitops.eq arg476 (Bits.of_int 0 64) && 
          Bitops.eq arg477 (Bits.of_int 0 3) && Bitops.eq arg478 (Bits.of_int 1 
              1) && Bitops.eq arg472 (Bits.of_int 0 64) && Bitops.eq arg473 
            (Bits.of_int 0 3) && Bitops.eq arg474 (Bits.of_int 0 1) && 
          Bitops.eq arg468 (Bits.of_int 0 64) && Bitops.eq arg469 (Bits.of_int 
              0 3) && Bitops.eq arg470 (Bits.of_int 1 1) && Bitops.eq arg464 
            (Bits.of_int 0 64) && Bitops.eq arg465 (Bits.of_int 0 3) && 
          Bitops.eq arg466 (Bits.of_int 0 1) && Bitops.eq arg461 (Bits.of_int 0 
              3) && Bitops.eq arg462 (Bits.of_int 0 1) && Bitops.eq arg459 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1''''' && Bitops.eq rs2 
          ...
          Bitops.eq rs1 rs1''' && Bitops.eq rs2 rs2''' && Bitops.eq rs1 
            rs1'' && Bitops.eq rs2 rs2'' && Bitops.eq rs1 rs1' && Bitops.eq rs2 
            rs2' && (Bitops.eq arg501 (Bits.of_int 3 3) && Bitops.eq arg502 
            (Bits.of_int 32 32) && Bitops.eq arg500 (Bits.of_int 0 32) && 
          Bitops.eq arg497 (Bits.of_int 0 64) && Bitops.eq arg498 (Bits.of_int 
              0 3) && Bitops.eq arg499 (Bits.of_int 1 1) && Bitops.eq arg494 
            (Bits.of_int 0 64) && Bitops.eq arg495 (Bits.of_int 0 3) && 
          Bitops.eq arg496 (Bits.of_int 0 1) && Bitops.eq arg491 (Bits.of_int 0 
              64) && Bitops.eq arg492 (Bits.of_int 0 3) && Bitops.eq arg493 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1''''' && Bitops.eq rs1 rs1'''' && 
          Bitops.eq rs1 rs1''' && Bitops.eq rs1 rs1'' && Bitops.eq rs1 rs1' && 
          (Bitops.fits_signed arg526 13 && Bitops.eq arg525 (Bits.of_int 3 
              3) && Bitops.eq arg527 (Bits.of_int 32 32) && Bitops.eq arg524 
            (Bits.of_int 0 32) && Bitops.eq arg520 (Bits.of_int 0 64) && 
          Bitops.eq arg521 (Bits.of_int 0 3) && Bitops.eq arg522 (Bits.of_int 1 
              1) && Bitops.eq arg516 (Bits.of_int 0 64) && Bitops.eq arg517 
            (Bits.of_int 0 3) && Bitops.eq arg518 (Bits.of_int 0 1) && 
          Bitops.eq arg512 (Bits.of_int 0 64) && Bitops.eq arg513 (Bits.of_int 
              0 3) && Bitops.eq arg514 (Bits.of_int 1 1) && Bitops.eq arg508 
            (Bits.of_int 0 64) && Bitops.eq arg509 (Bits.of_int 0 3) && 
          Bitops.eq arg510 (Bits.of_int 0 1) && Bitops.eq arg505 (Bits.of_int 0 
              3) && Bitops.eq arg506 (Bits.of_int 0 1) && Bitops.eq arg503 
      ...
      when Base.to_bool (Bitops.eq rs1 rs1''''' && Bitops.eq rs2 
          ...
          Bitops.eq rs1 rs1''' && Bitops.eq rs2 rs2''' && Bitops.eq rs1 
            rs1'' && Bitops.eq rs2 rs2'' && Bitops.eq rs1 rs1' && Bitops.eq rs2 
            rs2' && (Bitops.eq arg545 (Bits.of_int 3 3) && Bitops.eq arg546 
            (Bits.of_int 32 32) && Bitops.eq arg544 (Bits.of_int 0 32) && 
          Bitops.eq arg541 (Bits.of_int 0 64) && Bitops.eq arg542 (Bits.of_int 
              0 3) && Bitops.eq arg543 (Bits.of_int 1 1) && Bitops.eq arg538 
            (Bits.of_int 0 64) && Bitops.eq arg539 (Bits.of_int 0 3) && 
          Bitops.eq arg540 (Bits.of_int 0 1) && Bitops.eq arg535 (Bits.of_int 0 
              64) && Bitops.eq arg536 (Bits.of_int 0 3) && Bitops.eq arg537 
